...
class EmbeddingForest():
  ...
  embedding_path='data/20ng_embeddings.pickle',
  inverse_vocabulary = None):
    ...
    self.classifier = ensemble.RandomForestClassifier(n_estimators=500, random_state=1, class_weight='balanced_subsample')
